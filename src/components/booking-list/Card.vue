  ...
  <div class="booking-list-card">
    <el-row>
      <el-col v-for="item in bookings" :key="item.id">
        <div @click="openDialog(item.id)" class="card">
          <el-row :gutter="15">
            <el-col :sm="24" :md="8">
...
.booking-list-card img.arrow-right {
  position: absolute;
  width: 1.6rem;
  height: 1.6rem;
  right: 1rem;
...
.booking-list-card .info-box p.faded {
  font-family: "PingFang HK";
  font-style: normal;
  font-weight: 400;
  font-size: 12px;
...
.booking-list-card .el-pagination {
...
.booking-list-card :deep(.el-pagination .btn-next),
.booking-list-card :deep(.el-pagination .btn-prev) {
